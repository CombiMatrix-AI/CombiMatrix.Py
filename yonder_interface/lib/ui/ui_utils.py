...
def change_theme(theme):
    ...
    path_to_stylesheet = ROOT_DIR / 'resources' / 'stylesheet.css'
    apply_stylesheet(QApplication.instance(), theme=theme, extra=extra, css_file=path_to_stylesheet)
