...
from .lib.ui.ui_utils import load_block_dict, init_adlink
from .lib.ui.step import Block
...
class CombiControlWindow(QMainWindow):
    def __init__(self):
        ...
        layout_master.addWidget(chip_test_button, 3, 0)
        layout_master.addWidget(exit_button, 4, 0)
