...
class Dask91xxLib:
    ...
    def AI_ContReadChannel(self, var_card, Channel, AdRange, BufferId, AI_READCOUNT, SampleRate, SyncMode):
        return self.libHandle.AI_ContReadChannel(var_card, Channel, AdRange, BufferId, AI_READCOUNT, SampleRate,
                                                 SyncMode)
    ...
    def AI_ContReadMultiChannels(self, card, CHANNELCOUNT, Chans, AdRanges, BufferId, AI_READCOUNT, SampleRate,
                                 SyncMode):
        rtn = self.libHandle.AI_ContReadMultiChannels(card, CHANNELCOUNT, Chans, AdRanges, BufferId, AI_READCOUNT,
                                                      SampleRate, SyncMode)
        return rtn
    ...
    def AI_ContScanChannels(self, var_card, CHANNELCOUNT, AdRange, BufferId, AI_READCOUNT, SampleRate, SyncMode):
        rtn = self.libHandle.AI_ContScanChannels(var_card, CHANNELCOUNT, AdRange, BufferId, AI_READCOUNT, SampleRate,
                                                 SyncMode)
        return rtn

    def AI_ContReadMultiChannelsToFile(self, var_card, CHANNELCOUNT, Chans, AdRanges, FileName, AI_READCOUNT,
                                       SampleRate, SyncMode):
        rtn = self.libHandle.AI_ContReadMultiChannelsToFile(var_card, CHANNELCOUNT, Chans, AdRanges, FileName,
                                                            AI_READCOUNT, SampleRate, SyncMode)
        return rtn
    ...
    def AO_ContWriteChannel(self, var_card, Channel, BufferId0, WriteCount, Iterations, Interval, definite, SyncMode):
        rtn = self.libHandle.AO_ContWriteChannel(var_card, Channel, BufferId0, WriteCount, Iterations, Interval,
                                                 definite, SyncMode)
        return rtn
    ...
    def AO_ContWriteMultiChannels(self, var_card, WRITECHNCNT, Chans, BufferId, WriteCount, Iterations, Interval,
                                  definite, SyncMode):
        rtn = self.libHandle.AO_ContWriteMultiChannels(var_card, WRITECHNCNT, Chans, BufferId, WriteCount, Iterations,
                                                       Interval, definite, SyncMode)
        return rtn
